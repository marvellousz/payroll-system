...
export async function PATCH(
  ...
  const auditFields = [
    ...
    { key: "monthly_salary", old: String(existing.monthly_salary), new_: body.monthly_salary !== undefined ? String(body.monthly_salary) : undefined },
    { key: "paid_leave_days", old: String(existing.paid_leave_days), new_: body.paid_leave_days !== undefined ? String(body.paid_leave_days) : undefined },
  ];
